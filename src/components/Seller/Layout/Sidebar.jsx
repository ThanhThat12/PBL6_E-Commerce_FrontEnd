...
import { MenuOutlined, ShoppingCartOutlined, UserOutlined, TagOutlined, CreditCardOutlined, BarChartOutlined, PlusOutlined, FileTextOutlined, StarOutlined, SettingOutlined, UsergroupAddOutlined, SafetyOutlined } from '@ant-design/icons';
...
const menuItems = [
  ...
  { path: '/seller/brands', icon: <BarChartOutlined />, label: 'Brand' },
